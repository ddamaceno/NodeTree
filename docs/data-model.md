...
Os diagramas UML do projeto estão em arquivos separados:

| Diagrama | Arquivo |
|---|---|
| Diagrama de classes | [`diagrama-classes.md`](diagrama-classes.md) |
| Diagrama de casos de uso | [`diagrama-casos-uso.md`](diagrama-casos-uso.md) |
